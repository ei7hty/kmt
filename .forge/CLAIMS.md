...
| date-floor-plus-7 | BUG FIXER (local_8ba9f198) | backend/quotes.mjs (cleanDate), backend/quotes.test.mjs, src/components/RequestDetails.jsx, .forge/audit-ui.mjs and any audit script with a baked-in submit date | 2026-09-06 |
