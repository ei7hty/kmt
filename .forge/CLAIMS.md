...
| owner-decision-density | JUNIOR FULL STACK ENGINEER (kmt-e8) | src/routes/QuoteRequests.jsx, src/App.css (sprint item 4: quote editor collapses behind an "Adjust quote" control, card height, three-row nav at 375px -- no rule/route/state change; branched from current main, after #296) | 2026-09-06 |
...
| markup-stale-size-count | JUNIOR BACK END DEV (local_0b9989ef) | src/markup.js (one comment line, #72's last item: the "290 sizes" claim is stale -- measured against getAllTires(), current count is 910 distinct sizes, matching src/data/catalog.js's own comment) | 2026-09-06 |
