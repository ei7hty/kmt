...
| outbox-table | DB ADMIN | backend/outbox.mjs, backend/outbox.test.mjs, docs/data-policy.md (redesign: structured data column, no body, request_id non-null) | 2026-09-06 |
