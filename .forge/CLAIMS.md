...
| --- | --- | --- | --- |
| `worktree-helper` | Claude (kmt CLI session) | new `scripts/worktree.mjs`; one line each in `.forge/AGENTS.md` (git section) and `README.md` (layout table, own commit) | 2026-09-06 |
