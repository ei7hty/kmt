...
| quote-declined-hook | JUNIOR BACK END DEV (local_0b9989ef) | backend/api.mjs (one line, the quote-declined mailer.after hook beside the existing quote-sent one), backend/api.test.mjs or quotes.test.mjs (its test) | 2026-09-06 |
