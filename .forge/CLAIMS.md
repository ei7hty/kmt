...
| --- | --- | --- | --- |
| `t59-brand-overhaul` | LEAD UI ENGINEER | t59 additions on the owner screens: request id and age on the card, oldest-first "Needs you", coverage metric wording (`QuoteRequests.jsx`, `OwnerInventory.jsx`) | 2026-09-06 |
