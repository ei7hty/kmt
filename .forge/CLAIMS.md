...
| --- | --- | --- | --- |
| `size-search-whole-size` | LEAD UI ENGINEER | the size search box on `/` accepts a whole size and says when nothing matches (`src/routes/CustomerRequest.jsx`, `src/App.css`) | 2026-09-06 |
