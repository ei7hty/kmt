...
| owner-google-signin-spec | PRODUCT MANAGER / OWNER AGENT (local_44d1e1f9) | new file .forge/owner-google-signin.md only (the what and why for replacing the shared owner password with Google sign-in restricted to the Workspace domain). Planning lane, no code. | 2026-09-06 |
