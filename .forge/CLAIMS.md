...
| --- | --- | --- | --- |
| canonical-host-headers | LEAD BACKEND DEV | backend/site.mjs (new) and its test, backend/server.mjs (handler top only), .forge/owner-backend.md (t46: #67, #132, app half of #102) | 2026-09-06 |
