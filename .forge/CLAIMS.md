...
| inquiries-table | DB ADMIN (local_adccdadc) | backend/inquiries.mjs, backend/inquiries.test.mjs, docs/data-policy.md (t65: the inquiries table and its migration only -- POST /api/inquiries is LEAD BACKEND DEV's, the owner-screen list is LEAD UI's) | 2026-09-06 |
