...
| release-header | LEAD BACKEND DEV | backend/site.mjs, backend/site.test.mjs, backend/server.mjs boot line (X-KMT-Release from KMT_RELEASE; stacked on canonical-host-headers) | 2026-09-06 |
