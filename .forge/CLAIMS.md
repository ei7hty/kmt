...
| `owner-card-supplier-facts` | LEAD UI ENGINEER | #105 fact line on the owner request card (`src/routes/QuoteRequests.jsx`, `src/App.css`); the zero-stock warning is JUNIOR FRONT END DEV's | 2026-09-06 |
