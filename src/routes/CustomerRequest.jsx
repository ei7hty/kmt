...
function CustomerRequest({ navigate }) {
  ...
  return (
    <div className="min-h-screen customer-shell">
      ...
      <SocialProof /><footer className="site-footer"><SocialProof variant="footer" /><span data-testid="copy-footer-brand">{COPY['footer.brand']}</span><span>Mobile tire service. Malden, MA.</span><a href="/privacy" className="privacy-link" onClick={event => { event.preventDefault(); navigate('/privacy') }}>Privacy</a></footer>
    </div>
  )
}
