...
function CustomerRequest({ navigate }) {
  ...
  return (
    <div className="min-h-screen customer-shell">
      ...
      <section className="hero-section"><div className="hero-copy"><p className="eyebrow">I COME TO YOU</p><h1 data-testid="hero-heading">Mobile Tire<br /><span>Service</span></h1><p className="hero-lede">Tires. Repairs. Roadside assistance.<br />You deal with me, start to finish.</p><button className="hero-cta" onClick={() => document.getElementById('order')?.scrollIntoView({ behavior: 'smooth' })}>Order Tires <span>→</span></button></div><div className="hero-visual" aria-label="Ken's Mobile Tire brand"><img className="hero-logo" src="/brand/kens-dark-1200.webp?v=2" srcSet="/brand/kens-dark-600.webp?v=2 600w, /brand/kens-dark-1200.webp?v=2 1200w" sizes="(max-width: 760px) 72vw, 420px" width="1200" height="1028" alt="Ken's Mobile Tire logo" /><span className="hero-visual-label">REAL MOBILE SERVICE / BOSTON</span></div></section>
      <section className="service-strip" id="services"><div><strong>◉</strong><span><b>I COME TO YOU</b>Home, work or roadside</span></div><div><strong>≡</strong><span><b>PRICE UP FRONT</b>See the whole quote before I turn up</span></div><div><strong>✓</strong><span><b>QUALITY SERVICE</b>Professional care every time</span></div><a className="btn btn-neutral service-urgent" href={URGENT_TEXT_HREF}>{TEXT_LABEL}</a><button className="btn btn-neutral" onClick={() => navigate('/inquiry')}>More than tires? Tell me</button></section>
