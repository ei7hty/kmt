    ...
    <div className="app-shell status-shell">
      ...
      <div className="owner-content">
        ...
        <div className="panel privacy-panel">
          ...
          <p>Ask, and Ken removes your name, contact details and address from the record. The quote itself stays, as the record of what was sold. Call <a href="tel:6174108319" className="link-action">(617) 410-8319</a>.</p>
